...
\begin{entrylist}
	\entry
		...
		{
		%\begin{tikzpicture}
		%	\draw[->,>={LaTeX[]},draw opacity=0] (0,2) arc (90:45:-1 and 0);
		%\end{tikzpicture}
...
\textbf{Experienced:} \texttt{CGI | Spring Framework | Eclipse | JUnit | OAuth | RStudio | MATLAB | Xero API | Facebook API}% Dummy text
\end{minipage}\\
%-----------------------------------------------------------------------------------
% Courses and skills
%-----------------------------------------------------------------------------------
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\textbf{Urdu/Hindi} - \score{5}{5}\\
	\textbf{Bhojpuri} - native
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	...
	Playing Badminton \& Chess.	Reading History, Philosophy \& Psychology. Discussing major world religions.
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
